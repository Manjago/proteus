...
/**
 * Instruction Set Architecture (ISA) v1.1
 * 
 * Standard instruction encoding (32 bits):
 * [8 bits: OpCode | 3 bits: R1 | 3 bits: R2 | 3 bits: R3 | 3 bits: R4 | 12 bits: reserved]
 * 
 * MOVI encoding (32 bits):
 * [8 bits: OpCode | 3 bits: R_dst | 21 bits: immediate]
 * 
 * Bits 31-24: OpCode (0-255)
 * Bits 23-21: Register 1 (0-7)
 * Bits 20-18: Register 2 (0-7) [or part of immediate for MOVI]
 * Bits 17-15: Register 3 (0-7) [or part of immediate for MOVI]
 * Bits 14-12: Register 4 (0-7) [or part of immediate for MOVI]
 * Bits 11-0:  Reserved [or part of immediate for MOVI]
 */
public enum OpCode {
    ...
    /** Move Immediate. R_dst = imm21 (21-bit unsigned constant) */
    MOVI(0x02, 1, "MOVI"),
